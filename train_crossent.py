...
def load_checkpoint(model, optimizer, losslogger, filename='saves/epoch_030_0.742_0.112.dat'):
...
if __name__ == "__main__":
    ...
    print(data.load_data(args.data))
    ...
    # net = 
    # model = torch.load("saves/epoch_030_0.742_0.112.dat")
